...
export default function App() {
  ...
  useGSAP(() => {
    ...
    // 1. INFINITE SLOW ROTATION (Applies globally)
    gsap.to(".spin-logo", {
      rotation: 360,
      repeat: -1,
      duration: 25, 
    ...
    mm.add("(min-width: 768px)", () => {
      ...
      gsap.to(logoContainerRef.current, {
        ...
        scrollTrigger: { trigger: "#section-footer", start: "top bottom", end: "bottom bottom", scrub: 1.5, immediateRender: false }
      });
    });
    ...
    mm.add("(max-width: 767px)", () => {
      ...
      // Less aggressive split for narrow screens
      gsap.to(logoLeftRef.current, {
      ...
      gsap.to(logoContainerRef.current, {
        ...
        scrollTrigger: { trigger: "#section-footer", start: "top bottom", end: "bottom bottom", scrub: 1, immediateRender: false }
      });
    });
